...
//*****************************************************************************************************
//Funcion para el Calculo de las masas efectivas de h y e de un ternario con contenido en nitrogeno
//*****************************************************************************************************
...
//*****************************************************************************************************
//Funcion para el Calculo de las masas efectivas de h y e de un cuaternario con contenido en nitrogeno
//*****************************************************************************************************
...
double Effective_mass_analytical_function(double x, char *type, int input){
double result;
...
if(type == "GaAsP"){
	...
	switch(input){
	    ...
	    case 1:
	      result=vegard_law(mN_e_GaAs, mN_e_GaP, C_mN_e_GaAsP, x);
        break;
        
		case 2:
	      result=vegard_law(mN_lh_GaAs, mN_lh_GaP, C_mN_lh_GaAsP, x);
        break;
		
		case 3:
	      result=vegard_law(mN_hh_GaAs, mN_hh_GaP, C_mN_hh_GaAsP, x);
        break;
	}
	...
	switch(input){
		...
		case 1:
	      result=Effective_Mass_N_ter(mN_e_GaP, En_GaPN, Em_GaPN, Cmn_GaP, x);
        break;
	...
	switch(input){
		case 1:
	      result=vegard_law(mN_e_InP, mN_e_GaP, C_mN_e_GaInP, x);
        break;

        case 2:
	      result=vegard_law(mN_lh_InP, mN_lh_GaP, C_mN_lh_GaInP, x);
        break;

        case 3:
	      result=vegard_law(mN_hh_InP, mN_hh_GaP, C_mN_hh_GaInP, x);
        break;
	 ...
	 switch(input){
	    case 1:
	      result=Effective_Mass_N_ter(mN_e_GaAs, En_GaAsN, Em_GaAsN, Cmn_GaAs, x);
        break;
